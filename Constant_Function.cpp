...
void Constant_Class::constant_function() const
{
    /**
     * 1. We cant modify any value here
     * 2. This type of function called access function.
    */
    std::cout<< "We are in constant function" << std::endl;
...
int main()
{
     ...
     Constant_Obj.constant_function();
