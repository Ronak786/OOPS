...
class Default_Constructor
{
    ...
    public:
        ...
        *    this->z = c;
        ...
        Default_Constructor(int a = 20, int b = 30 , int c = 40)   /*** Default Constrctor Argument****/
        {

            std::cout << "I am in Default Argument Prameterized constructor" << std::endl;
            this->x = a;
            this->y = b;        
            this->z = c;
...
int main()
{
     ...
     * 
     *   I am in Default Argument Prameterized constructor
     *   I am in Default Argument Prameterized constructor
     *   I am in Default Argument Prameterized constructor
     * 
     *   The value of x:20
